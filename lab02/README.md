...
предоставляют различный интерфейс для взаимодействия(разные параметры, разные форматы джисончиков). Без паттерна приложение должно знать структуру апи, использовать много if'ов; при добавлении сервиса придется писать новую ветку
